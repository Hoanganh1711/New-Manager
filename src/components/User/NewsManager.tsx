          ...
          <Row>
            ...
            <Col style={{ marginLeft: 30 }} className='info'>
              ...
              <div className='icons-group'>
                ...
                <div style={{ marginTop: 5 }}>
                  <PhoneOutlined />
                  <span style={{ marginLeft: 5 }}>0367093593</span>
                </div>
                <div style={{ marginTop: 5 }}>
                  <MailOutlined />
                  <span style={{ marginLeft: 5 }}>hoanggiaanh171193@gmail.com</span>
                </div>
              </div>
            </Col>
          </Row>
